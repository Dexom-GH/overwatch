<!-- ⚠️ UPSTREAM VERBATIM (NVIDIA, DeepStream 9.0 / TensorRT 10 / datacenter GPU).
     Do NOT run these commands as-is on the Jetson. Translate every step through
     ../OVERWATCH-ADAPTATION.md first: TRT 8.5 flags (--workspace MiB, not
     --memPoolSize 32768M), workspace ≤4096 MiB, batch-1, skip the PEAK_GPU_STREAMS loop. -->
