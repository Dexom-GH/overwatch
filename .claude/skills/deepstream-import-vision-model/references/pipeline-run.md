<!-- ⚠️ UPSTREAM VERBATIM (NVIDIA, DeepStream 9.0 / TensorRT 10 / datacenter GPU).
     The parser guidance (§6: network-type=0, net-scale-factor, cluster-mode, output
     decode) is the MOST portable part and applies to DS 6.x. But SKIP the multi-stream
     sweep (Step 7) — Overwatch has one camera. See ../OVERWATCH-ADAPTATION.md. -->
