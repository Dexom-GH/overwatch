<!-- ⚠️ UPSTREAM VERBATIM (NVIDIA). This whole phase (5 charts → HTML → PDF via
     wkhtmltopdf/pandoc/mermaid) is datacenter-oriented and NOT part of the Overwatch
     V1 edge deliverable. Do NOT install this toolchain on the Jetson. Perf numbers
     belong to the ADR-0001 benchmark gate (#8). See ../OVERWATCH-ADAPTATION.md. -->
