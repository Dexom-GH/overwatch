...
**hybrid** for V1; 0004 **CalVer + gated releases**
(→ [docs/RELEASING.md](docs/RELEASING.md)); 0005 (ReID weights licensing)
**resolved by 0007**; 0007 **licensing posture** (non-commercial / AGPL-3.0).
